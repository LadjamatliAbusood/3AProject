...
const submit = () => {
    form.post(`/cashier/${form.branch_id}/expenses`, {
        onSuccess: () => {
            form.reset();
            Swal.fire({
                icon: "success",
...
<template>
    ...
    <section class="relative w-full" data-aos="fade-up">
        <div class="grid grid-cols-2 grid-rows-0 gap-4">
            <!-- Add Expenses Card -->
            <div>
                <div class="bg-gray-100 p-6 rounded-lg shadow-md h-[320px]">
                    <h3 class="text-lg font-semibold text-gray-800">
                        Add Expenses
                    </h3>
                    <div class="flex items-center justify-center">
                        <form
                            class="max-w-md w-[900px] flex flex-col mt-2"
